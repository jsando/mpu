...
As soon as we process any statement that isn't a local decl, we can finalize all their offsets.

It can be invalid to declare a local once any instructions are generated, if that helps.
